...
const client_id='Y2xpZW50X2lkMTU1NjYxMTAwMzM1Nw==';
const client_key='Y2xpZW50X2tleTE1NTY2MTEwMDMzNTc=';
const client_secret='Y2xpZW50X3NlY3JldDE1NTY2MTEwMDMzNTc=';
		...
		if(err){
			...
			if(action){
				...
				if(actType==='99' || actType==='601' || actType==='631' || actType==='607' || actType==='608' || actType==='606' || actType==='9999'){
					if(actType==='9999'){
						let textProcess=action.serviceId.split('systemMesg')[1].split(',')[0].substring(3,);
						mesg=textProcess.substring(0,textProcess.length-1);
//						console.log(mesg.substring(0,3));
						let command_robot = mesg.substring(0,3);
